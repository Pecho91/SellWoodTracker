...
{
    public class SqlRequestedPeopleListRetrieverTests
    {       
        [Fact]
        public void GetRequestedPeople_All_ShouldRetrieveRequestedPeople()
        {
            ...
            var sqlRequestedPeopleListRetriever = new SqlRequestedPeopleListRetriever(sqlConnectionExecutorMock.Object);

            // Act
            var actualPeople = sqlRequestedPeopleListRetriever.GetRequestedPeople_All();
